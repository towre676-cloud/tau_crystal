...
def main():
    ...
    # Gaussian normalization Volume ∝ (det Σ)^(-1/2)
    log_vol_ratio = -0.5*logdet  # vs. identity null
    # Weyl quotient correction
    ...
    mani={"run_id":run_id,"timestamp_utc":ts,
          "claims":{"relative_index_volume":"log B ~ log Vol(model/null) on stack quotient"},
