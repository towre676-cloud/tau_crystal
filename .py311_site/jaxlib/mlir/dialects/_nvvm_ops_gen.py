...
def cp_async_bulk_tensor_prefetch(tma_descriptor, coordinates, im2col_offsets, *, mode=None, l2_cache_hint=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def read_ptx_sreg_globaltimer_lo(res, *, loc=None, ip=None) -> _ods_ir.Value:
...
def griddepcontrol(kind, *, loc=None, ip=None) -> _ods_ir.Operation:
...
def inline_ptx(write_only_args, read_only_args, read_write_args, ptx_code, *, predicate=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InlinePtxOp(writeOnlyArgs=write_only_args, readOnlyArgs=read_only_args, readWriteArgs=read_write_args, ptxCode=ptx_code, predicate=predicate, loc=loc, ip=ip))
...
def ldmatrix(res, ptr, num, layout, shape, elt_type, *, loc=None, ip=None) -> _ods_ir.Value:
...
def nanosleep(duration, *, loc=None, ip=None) -> _ods_ir.Operation:
