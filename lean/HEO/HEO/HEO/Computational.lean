...
/-!
  ...
  Operator: f x = 14 • x
  Density predicate: P n := n % 16 = 0, witness δ = 1/16.
-/
...
theorem Computational_linear_check :
...
@[simp] theorem Computational_f_three :
  ModuleContract.T.toFun (3 : Real) = 14 • (3 : Real) := by
  simp [nsmul_add]
