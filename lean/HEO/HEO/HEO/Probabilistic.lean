...
/-!
  ...
  Operator: f x = 10 • x
  Density predicate: P n := n % 12 = 0, witness δ = 1/12.
-/
...
theorem Probabilistic_linear_check :
...
@[simp] theorem Probabilistic_f_three :
  ModuleContract.T.toFun (3 : Real) = 10 • (3 : Real) := by
  simp [nsmul_add]
